...
namespace DailyRunner
{
    ...
    internal class FillMissingOhlcv
    {
        ...
        private readonly int _defaultStartDateIfMissing = 200;
        ...
        public FillMissingOhlcv(Api api, IConfiguration config, ILoggerFactory loggerFactory)
        {
            ...
            _defaultStartDateIfMissing = Convert.ToInt32(config["FillMissingOhlcv:DefaultStartDateIfMissing"] ?? "200");
        ...
        private async Task<List<MissingStockInstrumentsObject>> GetMissingStockOhlcvInstruments(DateTime startDateTime, string spName)
        {
            ...
            return await _dbReader!.ExecuteStoredProcedure(spName, parameters!, reader => DataReaderHelper.MapReaderTo<MissingStockInstrumentsObject>(reader));
        }
