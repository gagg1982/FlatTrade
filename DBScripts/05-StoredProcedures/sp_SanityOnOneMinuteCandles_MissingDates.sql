IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_SanityOnOneMinuteCandles_MissingDates]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [dbo].[sp_SanityOnOneMinuteCandles_MissingDates]
GO


CREATE OR ALTER PROCEDURE dbo.sp_SanityOnOneMinuteCandles_MissingDates
